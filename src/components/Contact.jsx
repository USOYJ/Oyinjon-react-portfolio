...
const Contact = () => {
  return (
    <div className="md:px-10 px-7 my-10" id="contact">
      ...
      <div className="float ">
        <a href="https://github.com/USOYJ" target="_blank" rel="noreferrer">
          <img src={github} alt="" style={{ width: '10%'}}/>
        </a>
        <a href="https://www.linkedin.com/in/oyindamola-jongbo-08b781165/" target="_blank" rel="noreferrer">
          <img src={linkedin} alt="" style={{ width: '10%'}}/>
        </a>
         <a className="ml-4" href="mailto:oyindajongbo@gmail.com" target="_blank" rel="noreferrer">
        <img src={gmail} alt="" style={{ width: '10%'}} />
        </a>
      </div>
        </div>
        {/* form */}
        <div className="md:w-1/2">
            <p className="mt-16 text-white text-2xl mb-6">Contact me, let's work together</p>
            <form>
